...
Этот пример эмулирует асинхронное получение данных о книге по её ID и возвращает промис, который возвращает с информацией о книге или отклоняется с ошибкой (если книга не найдена).
*/
	...
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			if (bookInfo) {
				...
				reject(`Книга с ID ${bookId} не найдена`)
			}
		}, 1000)
	})
}
